...
class LeapNode:
    def __init__(self):
        ...
        self.curr_lim = float(rospy.get_param('/leaphand_node/curr_lim', 150.0)) #don't go past 600ma on this, or it'll overcurrent sometimes for regular, 350ma for lite.
        self.ema_amount = 0.2
